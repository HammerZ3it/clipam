...
// subnetDnsCmd represents the subnetDns command
var subnetDnsCmd = &cobra.Command{
	Use:   "subnetDns",
...
func init() {
	...
	// subnetDnsCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// subnetDnsCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
