...
// subnetNetmaskCmd represents the subnetNetmask command
var subnetNetmaskCmd = &cobra.Command{
	Use:   "subnetNetmask",
...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("subnetNetmask called")
	},
}

func init() {
	subnetCmd.AddCommand(subnetNetmaskCmd)
